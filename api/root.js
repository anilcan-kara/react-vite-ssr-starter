...
// const list4 = fs.existsSync(`${currentDir}/api/build`) && fs.readdirSync(`${currentDir}/api/build`) || []
...
// const list6 = fs.existsSync(`${parentDir}/api/build`) && fs.readdirSync(`${parentDir}/api/build`) || []

// console.log(`list6.length`, list6.length);
// console.log(`list6`, list6);

// const list7 = fs.existsSync(`${parentDir}/api/build/server`) && fs.readdirSync(`${parentDir}/api/build/server`) || []

// console.log(`list7.length`, list7.length);
// console.log(`list7`, list7);

// const list8 = fs.existsSync(`${parentDir}/api/build/client`) && fs.readdirSync(`${parentDir}/api/build/client`) || []

// console.log(`list8.length`, list8.length);
// console.log(`list8`, list8);

export const root = parentDir

export const current = currentDir
